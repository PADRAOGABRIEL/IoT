...
// WIFI
const char* myHostname = "PadraoHost"; // Nome do host na rede
const char* SSID = "dada"; // SSID / nome da rede WI-FI (AP) do WiFiManager 
const char* PASSWORD = ""; // Senha da rede WI-FI (AP) do WiFiManager
