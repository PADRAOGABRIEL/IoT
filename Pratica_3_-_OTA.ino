...
const char* SSID = "PREDIALNET_2G_E5F6"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "57086279"; // Senha da rede WI-FI que deseja se conectar
...
void initOTA()
{
  ...
  // No authentication by default
   ArduinoOTA.setPassword((const char *)""); // senha para carga via WiFi (OTA)
  ArduinoOTA.onStart([]() {
